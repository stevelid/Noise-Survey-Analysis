...
def get_common_utility_functions():
    ...
    // Initialize global references
        ...
        console.log("Initializing click lines after delay...");
        charts ? console.log("Charts:", charts) : console.log("Charts not found");
        sources ? console.log("Sources:", sources) : console.log("Sources not found");
        labels ? console.log("Labels:", labels) : console.log("Labels not found");
        click_lines ? console.log("Click lines:", click_lines) : console.log("Click lines not found");
        ...
        for (let i = 0; i < charts.length; i++) {
            ...
            // Debug: List all renderers in the chart
            console.log("Chart", i, "Renderers:", charts[i].renderers.map(r => r.name));
            ...
            console.log("Chart ", i, ": Click line =", clickLine, "Label =", label);
        ...
        console.log("Final click lines:", window.clickLineRefs);
        console.log('Label references:', window.labelRefs);
