...
class DashBuilder:
    ...
    def _assemble_js_bridge_dictionary(self) -> dict:
        ...
        js_models = {
            ...
            'comparisonMetricsDiv': self.shared_components['comparison_panel'].metrics_placeholder,
            'comparisonFrequencyLayout': self.shared_components.get('comparison_frequency_layout'),
            'comparisonFrequencyPlaceholder': self.shared_components['comparison_frequency'].placeholder_div,
